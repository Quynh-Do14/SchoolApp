export const messageConfig = (message: string) => {
    switch (message) {
        ...
        case "username_not_exists":
            return `Tài khoản không tồn tại. Vui lòng đăng kí tài khoản để sử dụng hệ thống`;
        case "wrong_password":
            return `Mật khẩu không chính xác. Vui lòng kiểm tra lại thông tin đăng nhập`;
        case "username_exists":
            return `Tài khoản đã tồn tại. 
                    Vui lòng đăng kí tài khoản khác`;
        case "email_exists":
            return `Email đã được sử dụng. Vui lòng đăng kí email khác khác`;
